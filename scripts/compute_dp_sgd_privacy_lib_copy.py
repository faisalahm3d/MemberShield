...
def compute_dp_sgd_privacy_statement(
  ...
  """
  example_eps_no_subsampling = None
  example_eps_subsampling = None
  user_eps_no_subsampling = None
  user_eps_subsampling = None
...
epsilon to still be infinite.""",
  ...
  #return '\n\n'.join(paragraphs) + '\n'
  return example_eps_no_subsampling, example_eps_subsampling, user_eps_no_subsampling, user_eps_subsampling
